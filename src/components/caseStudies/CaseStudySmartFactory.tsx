        ...
        <article className="min-h-screen bg-white" ref={sectionRef}>
            ...
            <header className="relative pt-20 pb-16 px-6 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-100/30 rounded-full blur-3xl animate-float-slow" />
                ...
                <div className="relative z-10 max-w-[1200px] mx-auto">
                    ...
                    >
                        ...
                        <ChevronRight size={14} />
                        <span className="text-blue-600 font-medium">Smart Factory IoT</span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            >
                                How a 100-year-old manufacturer
                                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-emerald-600 bg-[length:200%_auto] animate-gradient-shift">
                                    cut costs 40%
                                </span>
                                <span className="block text-3xl sm:text-4xl lg:text-5xl text-gray-700 mt-2">
                                    with a connected factory
                                </span>
                            </h1>
                            ...
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
                                ...
                                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-sm font-bold text-gray-900">40% Cost Reduction</div>
                                            <div className="text-[10px] text-gray-500">Year-over-year savings</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float" style={{ animationDelay: '1s' }}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-[10px] text-gray-500">Since deployment</div>
                                        </div>
                                    </div>
                                </div>
