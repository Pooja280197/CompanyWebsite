        ...
        <article className="min-h-screen bg-white">
            ...
            <header className="relative pt-20 pb-16 px-6 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-cyan-100/20 rounded-full blur-3xl animate-float-slow" />
                    <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-100/20 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: '2s' }} />
                    ...
                    {/* Cloud floating icons */}
                    <div className="absolute top-20 right-20 text-5xl opacity-20 animate-float-slow">☁️</div>
                    <div className="absolute bottom-20 left-20 text-4xl opacity-20 animate-float-slow" style={{ animationDelay: '1.5s' }}>☁️</div>
                    <div className="absolute top-1/2 right-1/4 text-3xl opacity-20 animate-float-slow" style={{ animationDelay: '3s' }}>☁️</div>
                </div>
                ...
                <div className="relative z-10 max-w-[1200px] mx-auto">
                    ...
                    >
                        ...
                        <ChevronRight size={14} />
                        <span className="text-blue-600 font-medium">Cloud Optimization</span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            >
                                99.99% uptime on a
                                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 bg-[length:200%_auto] animate-gradient-shift">
                                    cloud bill 35% smaller
                                </span>
                            </h1>
                            ...
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
                                ...
                                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-sm font-bold text-gray-900">99.99% Uptime</div>
                                            <div className="text-[10px] text-gray-500">Enterprise-grade reliability</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float" style={{ animationDelay: '1s' }}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-sm font-bold text-gray-900">35% Cost Savings</div>
                                            <div className="text-[10px] text-gray-500">Smart resource allocation</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20 shadow-lg animate-pulse-soft">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-medium text-gray-700">Optimized</span>
                                    </div>
                                </div>
                            </div>
