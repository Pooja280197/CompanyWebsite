        ...
        <article className="min-h-screen bg-white">
            ...
            <header className="relative pt-20 pb-16 px-6 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute top-20 left-10 text-4xl animate-pulse-soft">💎</div>
                    <div className="absolute bottom-20 right-10 text-3xl animate-pulse-soft" style={{ animationDelay: '1s' }}>✨</div>
                    <div className="absolute top-1/2 left-1/4 text-2xl animate-pulse-soft" style={{ animationDelay: '2s' }}>💠</div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            >
                                ...
                                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 bg-[length:200%_auto] animate-gradient-shift">
                                    judge diamonds
                                </span>
                                <span className="block text-3xl sm:text-4xl lg:text-5xl text-gray-700 mt-2">
                                    80% accuracy, 60% faster
                                </span>
                            </h1>
                            ...
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
                                ...
                                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center animate-bounce-soft">
                                            <Target size={18} className="text-blue-600" />
                                        </div>
                                        <div>
                                            <div className="text-sm font-bold text-gray-900">80% Accuracy</div>
                                            <div className="text-[10px] text-gray-500">Consistent AI predictions</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float" style={{ animationDelay: '1s' }}>
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-xl bg-emerald-50 flex items-center justify-center animate-pulse-soft">
                                            <Zap size={18} className="text-emerald-600" />
                                        </div>
                                        <div>
                                            <div className="text-sm font-bold text-gray-900">60% Faster</div>
                                            <div className="text-[10px] text-gray-500">Than manual evaluation</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20 shadow-lg animate-pulse-soft">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-medium text-gray-700">AI Live</span>
                                    </div>
                                </div>
                            </div>
