...
const STATS = [
  { value: '20%', label: 'Sales Lift', icon: TrendingUp, color: '#2563eb', bg: 'bg-blue-50', border: 'border-blue-200' },
  { value: '5', label: 'AI Engineers', icon: Users, color: '#7c3aed', bg: 'bg-purple-50', border: 'border-purple-200' },
  { value: '100%', label: 'In-House Knowledge', icon: Shield, color: '#059669', bg: 'bg-emerald-50', border: 'border-emerald-200' },
  { value: 'Embedded', label: 'Team Model', icon: Briefcase, color: '#d97706', bg: 'bg-amber-50', border: 'border-amber-200' },
];

const ENGAGEMENT_MODELS = [
  { icon: Users, title: 'Embedded Team', desc: 'Five AI developers working inside client workflow', color: '#2563eb', bg: 'bg-blue-50' },
  { icon: Brain, title: 'Predictive Models', desc: 'AI that turns customer data into actionable insight', color: '#7c3aed', bg: 'bg-purple-50' },
  { icon: Target, title: 'Advanced Segmentation', desc: 'Targeted campaigns that actually convert', color: '#059669', bg: 'bg-emerald-50' },
  { icon: TrendingUp, title: 'Campaign Targeting', desc: 'Data-driven marketing that fires with precision', color: '#d97706', bg: 'bg-amber-50' },
];

const TECHNOLOGIES = [
  { icon: Brain, name: 'Predictive Analytics', color: '#2563eb', bg: 'bg-blue-50' },
  { icon: Users, name: 'Customer Segmentation', color: '#7c3aed', bg: 'bg-purple-50' },
  { icon: Target, name: 'Campaign Optimization', color: '#059669', bg: 'bg-emerald-50' },
  { icon: Database, name: 'Data Integration', color: '#d97706', bg: 'bg-amber-50' },
  { icon: BarChart3, name: 'Performance Analytics', color: '#dc2626', bg: 'bg-red-50' },
  { icon: Shield, name: 'Data Privacy', color: '#0891b2', bg: 'bg-cyan-50' },
];

const TIMELINE = [
  { phase: 'Team Onboarding', desc: 'Five AI developers embedded into client team', duration: '1 week', icon: UserPlus, color: '#2563eb' },
  { phase: 'Data Discovery', desc: 'Mapped customer data across systems', duration: '2 weeks', icon: Database, color: '#7c3aed' },
  { phase: 'Model Development', desc: 'Built predictive and segmentation models', duration: '6 weeks', icon: Brain, color: '#059669' },
  { phase: 'Campaign Integration', desc: 'Connected models to marketing systems', duration: '3 weeks', icon: Target, color: '#d97706' },
  { phase: 'Optimization', desc: 'Fine-tuned for maximum performance', duration: 'Ongoing', icon: TrendingUp, color: '#dc2626' },
];
...
export default function RetailAITeam() {
  ...
  return (
    <article className="min-h-screen bg-white">
      {/* Hero Section - People/Team Theme */}
      <header className="relative pt-20 pb-16 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-rose-100/20 rounded-full blur-3xl animate-float-slow" />
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-orange-100/20 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: '2s' }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-pink-100/10 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: '4s' }} />
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          ...
          >
            ...
            <ChevronRight size={14} />
            <span className="text-rose-600 font-medium">Retail AI Team</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              >
                Five embedded AI engineers,
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-rose-600 via-orange-500 to-amber-500 bg-[length:200%_auto] animate-gradient-shift">
                  one 20% sales lift
                </span>
              </h1>
              ...
              >
                <span className="flex items-center gap-2 px-4 py-2 rounded-full bg-rose-50 border border-rose-200 text-sm text-rose-700 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                  <Users size={16} className="text-rose-500" />
                  Staff Augmentation
                </span>
                <span className="flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 border border-orange-200 text-sm text-orange-700 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
                <img
                  src={HERO_IMAGE}
                  alt="Retail AI team collaboration"
                ...
                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-gray-900">20% Sales Lift</div>
                      <div className="text-[10px] text-gray-500">Targeted campaigns</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-float" style={{ animationDelay: '1s' }}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-gray-900">5 AI Engineers</div>
                      <div className="text-[10px] text-gray-500">Embedded in client team</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20 shadow-lg animate-pulse-soft">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-gray-700">Team Active</span>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-8 -right-8 flex gap-2 opacity-30">
                {[0, 1, 2].map((i) => (
                  <span 
                    ...
                    style={{ 
                      background: ['#e11d48', '#f97316', '#d97706'][i],
        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            <div className="lg:col-span-3">
              <div 
                className="inline-block px-3 py-1 rounded-full bg-rose-100 border border-rose-200 mb-4"
                style={{
              ...
              >
                <span className="text-xs font-bold text-rose-700 tracking-wider">OVERVIEW</span>
              </div>
              <h2 
              ...
              >
                A retail company sitting on customer data it couldn't use: fragmented across systems, feeding marketing campaigns that fired blind — missed opportunities on both sales and engagement.
              </p>
              <div 
                className="mt-6 flex items-start gap-4 p-5 rounded-2xl bg-gradient-to-br from-rose-50 to-orange-50 border border-rose-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                style={{
                  opacity: visibleStates[0] ? 1 : 0,
              ...
              >
                <Quote size={24} className="text-rose-500 flex-shrink-0 mt-1" />
                <div>
                  <p className="text-sm text-gray-700 italic">
                    "We had all this customer data but couldn't turn it into sales. We needed people who could build the models — inside our team."
                  </p>
                  <p className="text-xs text-gray-500 mt-2">— VP of Marketing</p>
                </div>
              </div>
            </div>
              ...
              >
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div 
                      key={item.label} 
                      className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100 hover:border-rose-200 transition-all duration-300 hover:shadow-sm"
                      style={{
                        opacity: visibleStates[0] ? 1 : 0,
                    ...
                    >
                      ...
                      <span className={`text-sm font-medium ${item.highlight ? 'text-rose-600' : 'text-gray-900'}`}>
                        {item.value}
                      </span>
                    </div>
                  ))}
        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            <div className="lg:col-span-2">
              ...
              >
                <span className="text-xs font-bold text-blue-700 tracking-wider">THE ENGAGEMENT</span>
              </div>
              <h2 
                className="text-3xl font-bold text-gray-900"
                style={{
            ...
            <div className="lg:col-span-3">
              ...
              >
                Rather than outsourcing a project, the client extended their team: five of our AI developers embedded directly into their workflow, under their direction. The team implemented predictive models, advanced segmentation, and campaign-targeting tools — turning the client's own data into actionable insight, inside the client's own walls.
              </p>
              <div 
                className="mt-4 p-4 rounded-xl bg-white border border-gray-200 hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                style={{
                  opacity: visibleStates[1] ? 1 : 0,
                  transform: visibleStates[1] ? 'translateY(0)' : 'translateY(20px)',
                  transition: 'all 0.6s cubic-bezier(0.22, 1, 0.36, 1) 0.3s',
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-900">The Knowledge Stayed In-House</div>
                    <div className="text-xs text-gray-500">Because the work happened in-house</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-12">
            ...
            >
              <span className="text-xs font-bold text-emerald-700 tracking-wider">WHAT THEY DELIVERED</span>
            </div>
            <h2 
              className="text-3xl font-bold text-gray-900"
              style={{
            ...
            >
              AI capabilities embedded in the team
            </h2>
            <p 
            ...
            >
              Five engineers, one mission: turn customer data into sales
            </p>
          </div>
      ...
      <section 
        ...
        className="py-16 px-6 bg-gradient-to-br from-rose-50 via-white to-orange-50"
      >
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-12">
            <div 
            ...
            {STATS.slice(0, 3).map((stat, i) => (
              ...
              >
                ...
                <div className="text-sm text-gray-500 mt-1">
                  {i === 0 && 'Through targeted campaigns and improved engagement' }
                  {i === 1 && 'Embedded directly into client workflow' }
                  {i === 2 && 'Knowledge stayed in-house, skills leveled up' }
                </div>
          ...
          >
            <p className="text-gray-700">
              <span className="font-semibold text-gray-900">20% sales lift, 5 engineers, one embedded team.</span>
              { ' ' }The client team leveled up alongside — the knowledge stayed in-house, because the work happened in-house.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-[900px] mx-auto">
          <div className="text-center mb-12">
            ...
            >
              <span className="text-xs font-bold text-rose-700 tracking-wider">TIMELINE</span>
            </div>
            <h2 
              className="text-3xl font-bold text-gray-900"
              style={{
          ...
          <div className="relative">
            ...
            >
              <div 
                className="h-full w-full bg-gradient-to-b from-rose-400 via-orange-400 to-amber-400"
                style={{
                ...
                >
                  <div className="absolute left-5 md:left-1/2 -translate-x-1/2 z-10">
                    <div 
                      ...
                      style={{ 
                        borderColor: activeTimeline === index ? '#e11d48' : item.color,
                    ...
                    <div
                      className={`p-5 rounded-xl bg-white border transition-all duration-500 ${
                        activeTimeline === index 
                          ? 'shadow-xl border-rose-300 -translate-y-1' 
      ...
      >
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-rose-100/30 rounded-full blur-2xl animate-float-slow" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-orange-100/30 rounded-full blur-2xl animate-float-slow" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10 max-w-[700px] mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-100 border border-rose-200 mb-4">
              <Users size={12} className="text-rose-600" />
              <span className="text-xs font-bold text-rose-700 tracking-wider">STAFF AUGMENTATION</span>
            </div>
            
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
              Need skills, not a vendor?
            </h2>
            <p className="text-gray-600 mt-3 max-w-lg mx-auto">
              Extend your team with vetted engineers who work inside your workflow — not outside it.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3 mt-6">
              <Link
                to="/staff-augmentation"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-rose-600 to-orange-500 text-white font-medium hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 hover:scale-105"
              >
            ...
            <p className="text-xs text-gray-400 mt-3">No obligation. Just a conversation about your team's needs.</p>
          </div>
        </div>
      </section>
