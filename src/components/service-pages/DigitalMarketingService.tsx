...
const HERO_TAGLINE = `A beautiful site nobody finds is a brochure in a drawer. Our web development services engineer for the three things that matter: speed, search, and conversion.`;
...
const HERO_TITLE_LINES = [
  ...
  {
    words: [{ text: 'MARKETING' }],
    letterCount: 9,
    inline: false,
    startDelay: 7 * HERO_LETTER_INTERVAL,
  }
];
...
export default function DigitalMarketingService() {
  ...
  useEffect(() => {
    document.title = 'Digital Marketing — NSS';
    ...
    script.id = 'digital-marketing-faq-schema';
    script.textContent = JSON.stringify(schema);
    document.head.appendChild(script);

    return () => {
      document.title = 'NSS — Software that ships';
      document.getElementById('digital-marketing-faq-schema')?.remove();
    };
  }, []);
  ...
  return (
    <article className="min-h-screen bg-white">
      ...
      <header className="webdev-hero relative border-b border-white/10 px-6">
        <ServiceHeroBackground image={HERO_IMAGES.digitalMarketing} />
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto w-full">
          <div className="max-w-[58rem] text-left">
            ...
            <p className="webdev-hero__desc a2 text-sm sm:text-base leading-[1.7] max-w-[38rem] tracking-[0.01em]">
              When your process is your edge, forcing it into off-the-shelf templates costs more than it saves.
              We build custom software development solutions around the way you actually work.
            </p>
